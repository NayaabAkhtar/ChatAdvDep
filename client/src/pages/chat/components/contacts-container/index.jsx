...
const ContactsContainer = () => {
  ...
  return (
    <div className="relative md:w-[35vw] lg:w-[30vw] xl:w-[25vw] bg-[#1b1c24] border-r-2 border-[#2b303b] w-full">
      <div className="pt-3">
        <Logo/>
      </div>
      <div className="my-5">
...
const Logo = () => {
  return (
    <div className="flex p-5 justify-start items-center gap-2">
      ...
      <span className="text-3xl font-bold">ChatWave</span>
    </div>
  );
};
...
const Title=({text})=>{
  return(
    <h6 className="uppercase tracking-widest text-neutral-300 pl-10 font-normal text-opacity-90 text-sm">{text}</h6>
  )
}
